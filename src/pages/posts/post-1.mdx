...
<span class="HL-text"> 
<strong>NOTE</strong> This merely meant as supplementary material, make sure to DYOR and make sure the information included below is still current and/or relevant.<br />
<strong>NOTE</strong> All notes in green throughout this document have been included to provide guidance and/or help you tailor the revision materials to your experience, please pay attention to those.
</span>
...
<span class="HL-text">
<strong>NOTE</strong> If your contract is not NEC you should only skim this section and create similar notes for your contract suite (ICC, JCT, FIDIC, Bespoke etc..).<br />
<strong>NOTE</strong> If your contract is an NEC contract you need to know the general information below as well as the specific to your contract (covered later on).
</span>
...
<span class="HL-text">**NOTE** You should be able to answer all the following questions.</span>

1. How do the CDM roles work with *(details omitted for confidentiality)* being client and principal designer, while **my company** is Lead designer? <br />
HS2 has the CDM responsibilities of a client and principal designer which means, in addition to their client duties they:
- plan, manage, monitor and coordinate health and safety in the pre-construction phase, including management of the health & safety file.
- collate the pre-construction information, and provide the information designers and contractors need to carry out their duties .
...
- liaise with the principal contractor, keeping them informed of any risks that need to be controlled during the construction phase.<br />

**My company** have the CDM role of designer, so we are responsible for making sure:
- conduct our designs in line with H&S regulations and the hierarchy of controls.
- provide information to HS2 as client and PD for the pre-construction plan and health & safety file.
- provide information to HS2 and EKFB for the construction phase plan.
- cooperate and coordinate with other designers and contractors.

2. What are the responsibilities of a client (CDM)?<br />
- appointing principal contractor and designer, and ensuring they have suitable skills and capabilities.
- allowing sufficient time and resources for the project.
- making sure that the principal contractor and designer appointed carry out their duties.
- making sure suitable welfare facilities are provided for the duration of the construction work.
- provide pre-construction information to any contractor and designer either bidding or already appointed.
- ensure that the principal contractor prepares a construction phase plan before construction begins.
- ensure that the principal designer prepares a health and safety file for the project, and that is revised as necessary and made available for anyone who needs it.

3. What are the responsibilities of a principal designer (CDM)?<br />
- plan, manage, monitor and coordinate health and safety in the pre-construction phase, including maintaining the health and safety file; taking account of all relevant information that may affect the design work both before and after construction has started.
- help and advise the client in bringing together the pre-construction information.
- work with any other design to eliminate foreseeable health and safety risks to anyone affected by the work, and where to possible to reduce or control those risks.
- ensure that anyone involved in the pre-construction phase communicates and cooperates, coordinating their work wherever required.
- liaise with the principal contractor, keeping them informed of any risks to be controlled during the construction phase.

4. What are the responsibilities of a principal contractor (CDM)?<br />
- plan, manage, monitor and coordinate the construction phase.
- manage and control health and safety risks during construction.
- liaise with the client and principal designer for the duration of the project to ensure that all health and safety risks are effectively managed.
- prepare a written construction phase plan, before the construction phase, implement, and then review and revise it as necessary.
...
- check that anyone they appoint has the adequate skills and capabilities to competently carry out their duties.
- ensure that all workers have site-specific inductions and any further training or information they need.
...
5. What are the responsibilities of a designer (CDM)?<br />
- make sure client is aware of their duties under CDM regulation.
- take account of any pre-construction information.
- eliminate foreseeable health and safety risks and reduce and control those which cannot be eliminated.
- provide design information to the principal designer for inclusion in the pre-construction information and the health and safety file.
- provide design information to the principal contractor and the client to help them comply with their duties, such as ensuring the construction phase plan is prepared.
- communicate, cooperate and coordinate with other designs and contractors.

6. What are the responsibilities of a contractor (CDM)?<br />
- make sure client is aware of their duties under CDM regulation.
- plan, manage and monitor all works undertaken by themselves and their workers.
- ensure that all they workers they employ/appoint has adequate skills, capabilities, experience and training to carry out their duties.
- provide appropriate supervision, information and instructions to their workers.
- ensure they do not begin work on site until reasonable steps have been takes to prevent unauthorised access. 
- ensure adequate welfare facilities are provided from the start and are maintained throughout the works.
- comply with direction given by the principal contractor and designer.
- comply with parts of the construction phase plan relevant to their work.
- coordinate their work with others on the project team.

7. What are the responsibilities of a worker (CDM)?<br />
- only undertake work they are competent in undertaking, or they are provided with sufficient training and supervision which allows them to undertake the work safely.
- make themselves aware of the health and safety risks involved in the work.
- always follow site rules and procedures.
- cooperate with other duty holders.
- report any risks they find to whoever controls the work on site.

8. What would you do to prepare to go on site?<br />
- I had already had a project wide safety induction and a site-specific safety induction (renewed yearly in January)
- I would familiarise myself with the task briefing and the method statement which includes a risk assessment for the activity.
- I would complete the COWI specific health and safety form including a risk form, emergency details, details of the activity etc… 
- I would ensure I have all the PPE necessary. 
- I would inform my manager that I am going down to the tunnel.
- I would make my way to site, receive a daily brief from the site supervisor and sign in.
- Conduct activity.
- Sign out and return to site office.

9. Did you prepare a method statement for the inspection at height?<br />
No, for that specific activity I was working under the contractor's already prepared method statement, which I had thoroughly read and includes a risk assessment form. I had already had a site induction but would receive a task briefing and then the daily site brief from the site supervisor when signing in on the day.
However my parent company's IMS H&S procedures also require me to complete a health and safety assessment form and submit to my manager which details the activity, time, emergency details and a risk assessment.


10. What is the role of the principal designer during the construction phase?<br />
Continue to provide their services as long as there are modifications being made to the design, when the appointment finishes and all the official duties have been discharged, ensure that the client and principal contractor have all the updated information regarding the design, especially the health and safety file.

11. Can a principal contractor also be a principal designer?<br />
Yes, there is nothing in CDM regulations which specifically prohibits this, but in certain types of contracts it may or may not be advantageous (traditional vs design and build).

12. What are the principles of prevention? (9 steps)<br />
- Avoid risk.
- Evaluate risks that can’t be avoided.
- Combat risk at source.
- Adapt work to the individual.
- Adapt to technical progress.
- Replace the dangerous with the non/less dangerous.
- Develop coherent overall prevention policy.
- Prioritise collective protective measure over individual measures.
- Appropriate instructions to employees.

13. Why do we apply the principles of prevention?<br />
Because they provide a clear framework for identifying and managing risks.

14. What do you do with risks you cannot eliminate?<br />
ERIC – Eliminate, Reduce, Isolate, Control

15. What is ERIC / ALARP?<br />
ERIC – Eliminate, Reduce, Isolate, Control<br />
ALARP – As Low As Reasonably Practicable<br />
Given by HSE, ALARP principle recognises that no activity is without risk and therefore the measures taken to eliminate, reduce or control risks should be proportionate to the benefits gained with regards to trouble, cost and time. Should always be based on sound engineering principles and best practice.

16. Do you have a CDM coordinator on your project?<br />
No, as the role no longer exists, the responsibilities are undertaken by the principal designer.

17. Who is ultimately responsible for proving welfare facilities on site?<br />
The client.

18. What are the duties of a CATIII checker under CDM regulations?<br />
There are no explicitly defined roles or responsibilities for a CATIII checker under CDM regulations, however we can consider them as designers and therefore they should abide by the same duties, including cooperating with other designs, ensuring all health and safety risks within their scope are eliminated, reduced and controlled, as well as included in the health and safety file. An example would be to check and highlight hazards identified during the checks.

19. What would you add to CDM regulations?<br />
A defined role and responsibilities for independent checkers (CATIII checkers).

20. What would you do if parties are not performing their CDM duties?<br />
As a designer I would immediately inform the client and principal designer, as the overall duty of ensuring all parties are correctly discharging their duties sits with the client but they can also be advised by the PD.
If the PD is not discharging their duties, I would inform the client and allow them to take the necessary steps.
If the client is not discharging their duties, such as providing complete pre-construction information to help with my work of allowing enough time and resources, I would remind them of their duties under CDM.
If a client does not understand their CDM duties, they can hire a CDM advisor to assist in that capacity.

21. Are there any reasons for managing H&S? If so, what are they?<br />
- the moral obligation of not letting harm befall others because of our actions.
- the financial case of detrimental effects to the project and company reputation.
- the legal case to avoid prosecution under civil/criminal law.

22. What do you understand from occupational health?<br />
Occupational health risks are any health issues that may arise as a result of undertaking certain work activities; examples include:
- hearing impairment
...
23. How do you communicate residual risks?
Through the risk register and clearly identifying hazards on drawings.

24. Is there a hierarchy in H&S regulation? If so, what is it?
- **Health and Safety at Work Act 1974**: lays out the duties employers have towards their employees, employees toward themselves and each other, and self-employed towards themselves and others. Enforced by the HSE.
- **Regulations (Statutory Instruments -SIs)**: Laws approved by parliament, which identify risks and set out specific laws and policies. Enforced by HSE and local authorities.
- **Approved Codes of Practice (ACOP)**: Offer practical examples of good practice, gives advice on complying with the law and what is reasonably practicable. Not enforceable but abiding by ACOPs ensures avoiding legal implications.
- **Guidance Documents**: HSE publishes guidance documents for various industries with specific health and safety advice.

25. What are the core principles of the **Health & Safety Act 1974**? 
- duties of employers to their employees and employees to themselves.
- safe place to work.
- safe equipment.
- proper training.
- risk assessment and ALARP.
- adequate facilities.
- competent person to oversee H&S.

26. Can you list some H&S Regulations?<br />
- CDM 2015 Regulation
- Reporting of Injuries, Disease and Dangerous Occurrences Regulation (RIDDOR)
...
- Lifting and Manual Handling Regulation
...
27. How is H&S in construction enforced?<br />
The HSE enforce H&S regulations and laws via notices:
- **Improvement Notice (IN)**: issued when an inspector believes a law is or has been breached but without serious risk of injury, the notice is issued with advised changes and a period of time for compliance.
- **Prohibition Notice (PN)**: issued when an inspector believes activities are likely to result in serious personal injury. PNs have an immediate impact on stopping the work until required changes are implemented.
Both INs and PNs are served to companies and form part of their permanent criminal record.<br />
Severe breaches are subject to prosecution.

28. Can HSE close a project? What is the name of the document used?<br />
Yes, a HSE inspector can issue a **prohibition notice (PN)** which has immediate effect in shutting down the work activities until the recommended rectifications are implemented.

29. When is a project notifiable under **CDM2015**?<br />
The client has the duty to notify HSW, using an F10 form if:
- lasts more than 30 days and more than 20 workers.
- exceeds 500 person days.

30. What is an **F10 form**?<br />
The form used to inform HSE if a project is notifiable.
For commercial projects, it’s the responsibility of the client.
For domestic projects, it’s the responsibility of the contractor or PC.

31. Are there any mandatory documents under **CDM2015**?
- Pre-construction information pack
- Construction Phase Plan
- Health and Safety File.

32. How many versions of CDM are there? Why have they been revised?<br /> 
Revisions include 1994, 2007 and 2015 (intended 2020 delayed).
The regulations were revised to improve practices and clarify roles such as:
- CDM coordinator role replaced with principal designer.
- simplifying regulations to make them easier to understand and follow.
- removing exemption of domestic clients.
- discourage bureaucracy.
- replacing ACOPs with more targeted guidance.

33. What are the key differences between CDM 2007 and 2015?<br />
- replace CDM coordinator with PD.
- replace ACOPs with more targeted guidance.
- remove exemption of domestic clients.
- split competence assessment into its component parts skills, knowledge, training and experience (and organisational capability)

34. What are the main hazards on site?<br />
...
35. What is the H&S File?<br />
- prepared by the **Principal designer** during the **pre-construction phase**.
- contains relevant health and safety information and should only contain information which helps in planning future construction work.
- includes: description of works, hazards not eliminated (residual risks), key structural principles (e.g. safe working loads), hazardous materials, cleaning/maintaining, removal/dismantle, significant services, information and as-built drawings.

36. What is the **construction phase plan**?<br />
- prepared by the principal contractor
- records arrangements for managing health and safety risks during construction
- forms the basis of communicating those arrangements to those involved in the construction phase.
- outlines H&S arrangements and site rules.
- should include project overview, risk analysis and safety protocols.

37. What is the purpose of a **risk assessment**? Are risk assessments mandatory?<br />
Yes, as part of the Health and Safety at Work regulations, risk assessments are mandatory.
They provide a systematic process of identifying hazards and evaluating risks within the workplace, then implementing reasonable control measures to remove or reduce them.

38. What the HSE process for completing a **risk assessment**? (5 steps)<br />
Identify-Evaluate-Implement-Review
...
39. What is a **hazard**?<br />
Something can cause harm.

40. What is a **risk**?<br />
The probability/likelihood that a hazard will cause harm.

41. What is a **near miss**? Are they good? Is it good practice to keep track of near misses? Why? <br />
A near miss or close call is an event which had the potential of causing harm but did not. It is important to record near misses because they highlight areas for H&S improvements.

42. What is the purpose of a **method statement**?<br />
A method statement is a document which sets out the H&S procedures and precautions put in place to control the risks identified in the risk assessment for a specific activity.

43. What does a **method statement** include?<br />
Contains information about the project and the task:
- project information.
- description of activity.
- location.
- time of start and duration.
- hazards associated with the activity.
- hazards associated with site and environment.
- planned sequence of work activities including H&S control measures.
- PPE requirements.
...
44. Why do you think there has been an improvement in H&S in the past 10 years?<br />
- continuation of work from the Health and Safety at Work Act, with specific regulations and guidance documents.
- increased awareness and competence.
- improved reporting.
- advent of new technologies improving our capabilities to eliminate reduce and control hazards.


45. What is a **Safe Systems of Work**?<br />
A method of work which puts in place control measures arising from a risk assessment, in order to eliminate identified hazards (where possible) and complete the work with minimum risk taking into consideration the realities of operations.

46. Is there an issue with work-life balance in construction? What would you do to improve it?<br />
The construction industry can be a very stressful environment with tight deadlines, strict budgets and significant responsibility.
Needs of employees have shifted from previous generations focussing on salary alone, to more consideration of employee benefits. <br />
A healthy work-life balance has been shown time and again to improve employee productivity and organisational efficiency, as employees show more proactivity and commitment. An example if the four-day work week trail at Microsoft which showed a boost in productivity by up to 40%.
We also have better technology nowadays, facilitating remote-work, faster and better modelling and analysis software, as well as more insightful project management software, without even mentioning the growing use of artificial intelligence.
Employers are beginning to place more emphasis on their employees’ mental and physical wellbeing.
To improve it I would:
- show trust in staff when offering flexible working arrangement, cannot come off as a settlement rather than a benefit.
- senior members should lead by example.
- incorporate discussions about using benefits, perks or better work arrangement in employee reviews.

47. Any major disasters you are aware of and what have you learned?<br />
- Grenfell fire (72 fatalities)
- Gerrards Cross Tunnel (0 fatalities):
- Seismic Activity in Turkey and Syria (~40k fatalities):


48. What is **RIDDOR**?<br />
**RIDDOR** is the Reporting of Injury, Disease and Dangerous Occurrence Regulations, which requires employers and people in charge of work premises, to report and keep track of:
- work related fatal incidents
- work related incidents which caused serious injury
- diagnosed cases of certain industrial diseases
- certain dangerous occurrences
**Dangerous occurrences** are incidents with a high potential to cause death or serious injury.

49. What is **COSHH**?<br />
COSSH is the Control of Substances Hazardous to Health Regulation, which includes laws and policies for the safe control of chemicals, fumes, dusts, vapours, nanotechnology, biological agents.
Substances not covered by COSHH: asbestos, lead, radioactive substances.

50. Explain the **Permit to Work**?<br />
When an activity is identified as high risk, we need strict controls. The **Permit-to-work** system provided a documented procedure that authorises certain people to carry out specific work within a specified period of time. It sets out the precautions required to complete the work safely.
The permit-to-work requires declarations from the authorising parties and the parties carrying out the work. Where necessary declarations may also be required from those involved in shift handover and extension of work.

51. Who appoints a designer under CDM?<br />
A client appoints a designer under CDM regulations.

52. What input would you have had which added to the **H&S file**?<br />
Construction tolerances, joint lip and steps between adjacent rings.
