...
u2.prototype.brand = i;
u2.prototype.h = function() {
  return true;
};
u2.prototype.S = function(i2) {
...
u2.prototype.subscribe = function(i2) {
  var t2 = this;
  return E(function() {
...
y2.prototype.S = function(i2) {
  ...
  u2.prototype.S.call(this, i2);
};
y2.prototype.U = function(i2) {
  if (void 0 !== this.t) {
    u2.prototype.U.call(this, i2);
    if (void 0 === this.t) {
      this.f &= -33;
...
function m(i2, t2) {
  l[i2] = t2.bind(null, l[i2] || function() {
  });
}
function _2(i2) {
  if (l3) l3();
...
m("__r", function(i2, n2) {
  ...
  if (r2) {
    r2.__$f &= -2;
    if (void 0 === (t2 = r2.__$u)) r2.__$u = t2 = function(i3) {
      var n3;
      E(function() {
        n3 = this;
      });
...
function b2(i2, n2, t2, r2) {
  ...
  return { o: function(i3, n3) {
    ...
    if (r2[n2] !== t3) {
      r2[n2] = t3;
      if (f2) i2[n2] = t3;
      else if (t3) i2.setAttribute(n2, t3);
...
x.prototype.shouldComponentUpdate = function(i2, n2) {
  ...
  for (var u3 in this.props) if (!(u3 in i2)) return true;
  return false;
};
...
var y3 = "undefined" == typeof requestAnimationFrame ? setTimeout : function(i2) {
  var n2 = function() {
    clearTimeout(t2);
    cancelAnimationFrame(r2);
    i2();
  }, t2 = setTimeout(n2, 100), r2 = requestAnimationFrame(n2);
};
var k = function(i2) {
...
function A2() {
  r(function() {
    var i2;
    while (i2 = p2.shift()) s2.call(i2);
  });
}
function F() {
  if (1 === p2.push(this)) (l.requestAnimationFrame || k)(A2);
}
...
//# sourceMappingURL=signals.module-G2TNVW7Y.js.map
