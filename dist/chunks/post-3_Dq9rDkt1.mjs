...
const html = () => "<h1 id=\"my-third-blog-post\">My Third Blog Post</h1>";
				...
				const file = "/home/cybermonki/gitProjects/blog/src/pages/posts/post-3.md";
				...
				function getHeadings() {
					return [{"depth":1,"slug":"my-third-blog-post","text":"My Third Blog Post"}];
				}
